...
#functional ports
set_load 0.5  [get_port CMP_Flag]
set_load 0.5  [get_port Arith_OUT]
set_load 0.5  [get_port Carry_OUT]
set_load 0.5  [get_port Arith_Flag]
set_load 0.5  [get_port Logic_OUT]
set_load 0.5  [get_port Logic_Flag]
set_load 0.5  [get_port Shift_OUT]
set_load 0.5  [get_port Shift_Flag]
